...
import com.sdk.cameraandgallery.database.MyDatabase
import com.sdk.cameraandgallery.databinding.ActivityImageSaveBinding
...
class ImageSaveActivity : AppCompatActivity() {
    private val binding by lazy { ActivityImageSaveBinding.inflate(layoutInflater) }
